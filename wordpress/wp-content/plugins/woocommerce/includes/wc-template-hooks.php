...
add_action( 'woocommerce_after_shop_loop_item_title', 'yith_ywbr_show_woocommerce_brands_loop' ,5);
/**
 * Subcategories.
 *
...
add_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_brand', 7 );
