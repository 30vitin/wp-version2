...
<h1 class="title-cart">Carrito de Compra</h1>
<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-7 ">
			...
			?>
            <div class="row">
                <div class="col-lg-3 col-md-3 product-thumbnail">
                    ...
                    <?php
							...
							if (intval($cart_item['quantity']) >= 10) {
								?>
									...
									class="form-control input-qualit qty" value="<?php echo intval($cart_item['quantity']); ?>">

								<?php

							} else { ?>

								<select name="cart[<?php echo $cart_item_key ?>][qty]" id=""
									class="form-control selected-qualit qty">
								...
								<input type="number" name="cart[<?php echo $cart_item_key ?>][qty]"
									class="form-control input-qualit qty d-none"
                ...
                <div class="col-lg-2 col-md-2 cart-total-line">
                    <?php
							echo apply_filters('woocommerce_cart_item_subtotal', WC()->cart->get_product_subtotal($_product, $cart_item['quantity']), $cart_item, $cart_item_key); // PHPCS: XSS ok.
							?>
                </div>
            </div>
            <hr class="hr-detalles">
            <?php } ?>
        ...
        <div class="col-lg-4 col-md-8 total-carrito-box">
            <!--<h2 class="title-cart-total">Total del Carrito</h2>-->
