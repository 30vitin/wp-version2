...
class bwp_ajax_filter_widget extends WP_Widget {
	...
	function __construct(){
		...
		add_action('wp_enqueue_scripts', array( $this, 'bwp_filter_script' ) );
	...
	function bwp_filter_products_callback(){
		global $wpdb;
		$dir =	WPBINGO_SHORTCODES_TEMPLATE_PATH.'bwp-ajax-filter/default_ajax.php';
		include $dir;
	}	
	
	function bwp_filter_script(){
	...
	protected function getTemplatePath($tpl='default', $type=''){
		$file = '/'.$tpl.$type.'.php';
		$dir = WPBINGO_SHORTCODES_TEMPLATE_PATH.'bwp-ajax-filter';
	...
	function woocommerce_filter_price($chosen_attributes,$default_min_price,$default_max_price){
		...
		<div class="bwp-filter-price">
		    <h3>'.esc_html__('Filter By Price','wpbingo').'</h3>
