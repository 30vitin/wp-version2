 ...
 **/
	...
	$default_posts_per_page = (isset($filter['product_count']) && $filter['product_count'] ) ? $filter['product_count'] : 12;
	$args = array(
		'post_type'             => 'product',
		'post_status'           => 'publish',
	...
	ob_start();
		...
		include(WPBINGO_SHORTCODES_TEMPLATE_PATH.'bwp-ajax-filter/products.php');
	...
	ob_start();
		include(WPBINGO_SHORTCODES_TEMPLATE_PATH.'bwp-ajax-filter/filter.php');
