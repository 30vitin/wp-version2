...
?>
<div class="bwp-filter-homepage slider tab-product-slider <?php echo esc_attr($class); ?>">
	...
	<div class="bwp-filter-content">
		...
		<div class="content-product-list">
			<div class="content products-list grid slick-carousel row" data-nav="<?php echo esc_attr($show_nav);?>" data-columns4="<?php echo $columns4; ?>" data-columns3="<?php echo $columns3; ?>" data-columns2="<?php echo $columns2; ?>" data-columns1="<?php echo $columns1; ?>" data-columns="<?php echo $columns; ?>">
