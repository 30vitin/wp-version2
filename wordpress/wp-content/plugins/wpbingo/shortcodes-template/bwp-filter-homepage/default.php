...
<div class="bwp-filter-homepage <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>" data-atributes="<?php echo esc_attr($atributes); ?>">
	<div class="bwp-filter-heading">
			...
			foreach($arr_category as $key => $cat){	?>
					<?php if($cat == 'all'){?>
						<li class="<?php if( ( $key + 1 ) == 1 ){echo 'active'; $cat_selected = $cat;}?>" data-value="<?php echo esc_attr($cat); ?>">
							<span><?php echo esc_html__( "All Category", 'wpbingo'); ?></span>
						</li>
					<?php }else{?>
						<?php 
		...
		<a class="bwp-filter-toggle"><?php echo  esc_html__( 'Filter', 'wpbingo' ); ?></a>	
		...
		<div class="bwp-filter-attribute">
			...
			<div class="clear_all"><span><?php echo  esc_html__( 'Clear All', 'bingo' ); ?></span></div>	
		</div>
	</div>
