...
<div class="bwp-recent-post slider layout2">
 <div class="block">
				...
				<div class="post-inner">
					...
					<div class="post-content">
						<div class="title-content">
							...
							<div class="show-more"><i class="ion-chevron-down"></i></div>
						</div>
						<div class="post-detail">
							<?php echo wpbingo_get_excerpt( $length, true ); ?>
							<div class="info-post">
								<?php wpbingo_posted_on3(); ?>	
								<span class="entry-link"><i class="ion-compose"></i><?php the_author_posts_link(); ?></span>
								<a class="post-btn-more" href="<?php echo esc_url(the_permalink()) ?>"><i class="fa fa-align-left"></i><?php echo  esc_html_e( 'Read more', 'wpbingo' ) ?></a>
							</div> 
						</div>
					</div>
				</div>
