...
<div class="bwp-recent-post slider default">
 <div class="block">
			...
			<?php } ?>
				...
				<div class="post-content">
					...
					<div class="entry-meta">
						<span class="entry-link"><?php esc_html_e( "By: ", 'wpbingo' )?><?php the_author_posts_link(); ?></span>
						<span class="entry-date-all">
							<?php esc_html_e( "on ", 'wpbingo' )?>
