    ...
    */
    ...
    class fashow_mega_menu {
        ...
        function __construct() {
			...
			add_action( 'wp_nav_menu_item_custom_fields', array( $this, 'fashow_mega_menu_add_custom_fields' ), 10, 5 );
			
            // add custom menu fields to menu
            add_filter( 'wp_setup_nav_menu_item', array( $this, 'fashow_mega_menu_add_custom_nav_fields' ) );

            // save menu custom fields
            add_action( 'wp_update_nav_menu_item', array( $this, 'fashow_mega_menu_update_custom_nav_fields' ), 10, 3 );

            // edit menu walker
            add_filter( 'wp_edit_nav_menu_walker', array( $this, 'fashow_mega_menu_edit_walker' ), 10, 2 );
         ...
         * @return      void
         */
        function fashow_mega_menu_add_custom_fields( $item_id, $item, $depth, $args ) {
			?>
        	<div class="menu-options">
				<?php if ( $depth == 0 ) { ?>
					<h4><?php esc_html_e( 'Mega Menu Options', 'fashow' ); ?></h4>
					<p class="field-custom description description-wide">
						<label
							for="edit-menu-megamenu-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Enable Mega Menu', 'fashow' ); ?>
					...
					<p class="field-custom description description-wide">
						<label
							for="edit-menu-is-fullwidth-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Full Width Mega Menu', 'fashow' ); ?>
                ...
                <h4><?php esc_html_e( 'Custom Menu Options', 'fashow' ); ?></h4>

                <p class="field-custom description description-wide">
                    <label
                        for="edit-menu-loggedin-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Visible only when logged in', 'fashow' ); ?>
                ...
                <p class="field-custom description description-wide">
                    <label
                        for="edit-menu-loggedout-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Visible only when logged out', 'fashow' ); ?>
				...
				<p class="field-custom description description-wide">
					<label
						for="edit-menu-newbadge-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'New Badge', 'fashow' ); ?>
				...
				<p class="field-custom description description-wide">
					<label
						for="edit-menu-salebadge-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Sale Badge', 'fashow' ); ?>
                ...
                <?php if ( $depth == 0 ) { ?>
					...
					<p class="field-custom description description-thin"
					   style="height: auto;overflow: hidden;width: 50%;float: none;">
						<label
							for="edit-menu-item-icon-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Menu Icon (Icon Mind / Font Awesome)', 'fashow' ); ?>
					...
					<p class="field-imagemenu description description-wide">
						...
						<?php esc_html_e( 'Menu Thumbnail', 'fashow' ); ?>
						...
						<?php } ?>
						<a class="bwp_upload_image_button" href="javascript:void(0);" data-image_id="edit-menu-item-imagemenu-<?php echo esc_attr($item_id);?>"><?php esc_html_e( 'Browse', 'fashow' ); ?></a>
						<a class="bwp_remove_image_button" href="javascript:void(0);" data-image_id="edit-menu-item-imagemenu-<?php echo esc_attr($item_id);?>"><?php esc_html_e( 'Remove', 'fashow' ); ?></a>
						</label>
					</p>					
                <?php } ?>				
                ...
                <?php if ( $depth >= 1 ) { ?>
                    ...
                    <h4><?php esc_html_e( 'Mega Menu Column Options', 'fashow' ); ?></h4>
					<p class="field-custom description description-wide">
						<label
							for="edit-menu-menucol-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Mega Menu Columns', 'fashow' ); ?></label>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-hidetitle-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Hide Title', 'fashow' ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megatitle-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Mega Menu No Link Title', 'fashow' ); ?>
					...
					<p class="field-imagecontent description description-wide">
						...
						<?php esc_html_e( 'Custom HTML Image', 'fashow' ); ?>
						...
						<?php } ?>
						<a class="bwp_upload_image_button" href="javascript:void(0);" data-image_id="edit-menu-item-imagecontent-<?php echo esc_attr($item_id);?>"><?php esc_html_e( 'Browse', 'fashow' ); ?></a>
						<a class="bwp_remove_image_button" href="javascript:void(0);" data-image_id="edit-menu-item-imagecontent-<?php echo esc_attr($item_id);?>"><?php esc_html_e( 'Remove', 'fashow' ); ?></a>
						</label>
					</p>
					
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-item-width-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Custom HTML Column Width (optional)', 'fashow' ); ?>
                    ...
                    <p><?php esc_html_e( 'Optionally set a width here for the menu column, ideal if you want to make it wider. Numeric value (no px).', 'fashow' ); ?></p>
                    </p>

                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-item-htmlcontent-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Custom HTML Column (within Mega Menu)', 'fashow' ); ?>
         ...
         * @return      void
         */
        function fashow_mega_menu_add_custom_nav_fields( $menu_item ) {
         ...
         * @return      void
         */
        function fashow_mega_menu_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
         ...
         * @return      void
         */
        function fashow_mega_menu_edit_walker( $walker, $menu_id ) {
    ...
    $GLOBALS['fashow_mega_menu'] = new fashow_mega_menu();
