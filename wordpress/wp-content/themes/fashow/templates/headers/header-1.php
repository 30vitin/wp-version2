	...
	<header id='bwp-header' class="bwp-header header-v1">
		...
		<div id="bwp-topbar">
			<div class="container">
				<div class="inner">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-3 topbar-leftr">
							<?php if(is_active_sidebar('top-link')){ ?>
								<div class="block-top-link pull-left">					
						...
						<div class="col-lg-3 col-md-3 col-sm-3 topbar-right">
							<?php if($show_wishlist && class_exists( 'YITH_WCWL' )){ ?>
								<div class="wishlist-box pull-right">
									<a href="<?php echo get_permalink( get_option('yith_wcwl_wishlist_page_id') ); ?>"><?php esc_html_e( 'Wishlist', 'fashow' ); ?></a>
								</div>
							<?php } ?>	
						</div>
					</div>
		...
		<div class='header-wrapper '>
			<div class="container">
				<div class='header-content' data-sticky_header="<?php echo esc_attr($enable_sticky_header); ?>">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 header-logo">
