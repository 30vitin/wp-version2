...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table">
		<tbody>
			<tr>
				<th><span><?php echo esc_html__("Image","fashow"); ?></span></th>
				<th><span><?php echo esc_html__("Product Name","fashow"); ?></span></th>
				<th><span><?php echo esc_html__("Price","fashow"); ?></span></th>
				<th><span><?php echo esc_html__("Qty","fashow"); ?></span></th>
			</tr>		
			<?php
